...
const Main = () => {
  ...
  return (
    <div className= 'p-4 flex flex-wrap justify-center items-center lg:w-2/4 w-11/12 mx-auto'>
        ...
        <p className='text-bold text-cyan-600 italic p-8'>Created by: <a className='underline text-cyan-100' target="_blank" href="https://github.com/Rabbi-Morgan?tab=repositories">Omobolaji Anuoluwapo</a></p>
    </div>
  )
}
